...
void main() {
  ...
  group('SecurityScreen — appPinBiometric switch', () {
    ...
    testWidgets(
      'switch is enabled (onChanged!=null) when appPinHash is set',
      (tester) async {
        final repo = _repo(
    ...
    testWidgets(
      'switch is OFF by default (appPinBiometricEnabled=false)',
      (tester) async {
        final repo = _repo(
          const AppSettings(defaults: AppDefaults(), appPinHash: 'h'),
        );
    ...
    testWidgets(
      'tapping switch ON persists appPinBiometricEnabled=true',
      (tester) async {
        final repo = _repo(
          const AppSettings(
    ...
    testWidgets(
      'tapping switch OFF persists appPinBiometricEnabled=false',
      (tester) async {
        final repo = _repo(
          const AppSettings(
            defaults: AppDefaults(),
    ...
    testWidgets(
      'switch toggle does NOT affect sessionEndPinBiometricEnabled',
      (tester) async {
        final repo = _repo(
          const AppSettings(
            defaults: AppDefaults(),
  ...
  group('SecurityScreen — sessionEndPinBiometric switch', () {
    testWidgets(
      'switch is disabled when sessionEndPinHash is null',
      (tester) async {
        final repo = _repo(const AppSettings(defaults: AppDefaults()));
        await tester.pumpWidget(_host(
          const SecurityScreen(),
    ...
    testWidgets(
      'switch is enabled when sessionEndPinHash is set',
      (tester) async {
        final repo = _repo(
          const AppSettings(
            defaults: AppDefaults(),
    ...
    testWidgets(
      'toggling ON persists sessionEndPinBiometricEnabled=true',
      (tester) async {
        final repo = _repo(
          const AppSettings(
            defaults: AppDefaults(),
    ...
    testWidgets(
      'toggling OFF persists sessionEndPinBiometricEnabled=false',
      (tester) async {
        final repo = _repo(
          const AppSettings(
            defaults: AppDefaults(),
    ...
    testWidgets(
      'session-end toggle does NOT affect appPinBiometricEnabled',
      (tester) async {
        final repo = _repo(
          const AppSettings(
            defaults: AppDefaults(),
  ...
  group('SecurityScreen — distressCancelBiometric switch', () {
    ...
    testWidgets(
      'switch is enabled when appPinHash is set',
      (tester) async {
        await tester.binding.setSurfaceSize(const Size(800, 1400));
        addTearDown(() => tester.binding.setSurfaceSize(null));
    ...
    testWidgets(
      'toggling ON persists distressCancelBiometricEnabled=true',
      (tester) async {
        await tester.binding.setSurfaceSize(const Size(800, 1400));
        addTearDown(() => tester.binding.setSurfaceSize(null));
    ...
    testWidgets(
      'toggling OFF persists distressCancelBiometricEnabled=false',
      (tester) async {
        await tester.binding.setSurfaceSize(const Size(800, 1400));
        addTearDown(() => tester.binding.setSurfaceSize(null));
  ...
  group('SecurityScreen — all three biometric toggles off', () {
    testWidgets(
      'all three biometric switches are off by default',
      (tester) async {
        await tester.binding.setSurfaceSize(const Size(800, 1400));
        addTearDown(() => tester.binding.setSurfaceSize(null));
    ...
    testWidgets(
      'all three switches render as disabled when no PINs are set',
      (tester) async {
        await tester.binding.setSurfaceSize(const Size(800, 1400));
        addTearDown(() => tester.binding.setSurfaceSize(null));
  ...
  group('SecurityScreen — PIN timeout slider', () {
    ...
    testWidgets(
      'dragging slider updates pinTimeoutSeconds',
      (tester) async {
        final repo = _repo(const AppSettings(defaults: AppDefaults()));
        await tester.pumpWidget(_host(
          const SecurityScreen(),
  ...
  group('SecurityScreen — duress PIN test row', () {
    testWidgets(
      'test row absent when duressPinHash is null',
      (tester) async {
        final repo = _repo(const AppSettings(defaults: AppDefaults()));
        await tester.pumpWidget(_host(
          const SecurityScreen(),
    ...
    testWidgets(
      'test row appears when duressPinHash is set',
      (tester) async {
        final repo = _repo(
          const AppSettings(
            defaults: AppDefaults(),
            duressPinHash: _stubHash,
          ),
        );
        await tester.pumpWidget(_host(
          const SecurityScreen(),
        ...
        await tester.pumpAndSettleTall();
        check(find.byIcon(Icons.verified_outlined).evaluate().length).isGreaterOrEqual(1);
      },
    );

    testWidgets(
      'tapping duress test row opens a dialog with a PinKeypad',
      (tester) async {
    ...
    testWidgets(
      'closing the duress-test dialog does not change settings',
      (tester) async {
        await tester.binding.setSurfaceSize(const Size(800, 1200));
        addTearDown(() => tester.binding.setSurfaceSize(null));
  ...
  group('SecurityScreen — PIN rows', () {
    ...
    testWidgets(
      'disable button visible when appPinHash is set',
      (tester) async {
        final repo = _repo(
          const AppSettings(defaults: AppDefaults(), appPinHash: 'h'),
        );
    ...
    testWidgets(
      'disabling app PIN clears appPinHash from stored settings',
      (tester) async {
        final repo = _repo(
    ...
    testWidgets(
      'disabling app PIN also disables appPinBiometricEnabled',
      (tester) async {
