...
| `wakelockServiceProvider` | `WakelockServiceProtocol` | `RealWakelockService` | `SimulationWakelockService` | `pending-5b` | spec 05 §WakelockService — [protocol](../lib/services/protocols/wakelock_service_protocol.dart) |
