...
| `locationServiceProvider` | `LocationServiceProtocol` | `RealLocationService` | `SimulationLocationService` | `pending-5b` | spec 05 §LocationService — [protocol](../lib/services/protocols/location_service_protocol.dart) |
