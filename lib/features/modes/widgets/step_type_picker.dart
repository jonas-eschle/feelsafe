...
Future<ChainStepType?> showStepTypePicker(
  ...
  builder: (context) {
    ...
    final entries = <(ChainStepType, String, IconData)>[
      ...
      (ChainStepType.countdownWarning, l.stepTypeCountdownWarning, Icons.timer),
      ...
      (ChainStepType.callEmergency, l.stepTypeCallEmergency, Icons.emergency),
      (
