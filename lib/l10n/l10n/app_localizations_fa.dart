...
class AppLocalizationsFa extends AppLocalizations {
  ...
  @override
  String get stepPickerMore => 'گزینه‌های بیشتر...';
  ...
  @override
  String get stepFieldRetryCount => 'تعداد تلاش‌های مجدد';

  @override
  String get stepFieldRandomize => 'پراکندگی زمانی';

  @override
  String get stepFieldRandomizeToggle => 'تصادفی‌سازی زمان (±20%)';

  @override
  String get stepFieldWaitTooltip => 'چقدر قبل از شروع این مرحله صبر شود.';

  @override
  String get stepFieldDurationTooltip =>
      'این مرحله تا چه زمانی فعال است قبل از شروع پنجره مهلت.';

  @override
  String get stepFieldGraceTooltip =>
      'زمان پس از فاز فعال برای تأیید ایمنی پیش از مرحله بعد.';

  @override
  String get stepFieldRetryCountTooltip =>
      'این مرحله چند بار تکرار شود قبل از تشدید.';

  @override
  String get stepFieldReminderIntervalTooltip =>
      'هر چند وقت یک‌بار یادآور پنهان در انتظار تأیید فعال می‌شود.';

  @override
  String get stepFieldReminderGraceTooltip =>
      'کاربر چقدر زمان دارد تا پس از ظاهر شدن یادآور ایمنی را تأیید کند.';
  ...
  @override
  String get stepPreviewTitle => 'پیش‌نمایش گام';

  @override
  String get stepPreviewMissingParams => 'ارجاع به گام یا حالت موجود نیست.';

  @override
  String get stepPreviewModeNotFound => 'حالت یافت نشد.';

  @override
  String get stepPreviewStepNotFound => 'گام در این حالت یافت نشد.';

  @override
  String stepPreviewError(Object error) {
    return 'پیش‌نمایش با خطا مواجه شد: $error';
  }

  @override
  String get stepPreviewReplay => 'پخش مجدد';

  @override
  String get stepPreviewHoldButtonHint =>
      'برای حس کردن پاسخ زنده، دکمه را نگه دارید.';

  @override
  String get stepPreviewHoldButtonLabel => 'نگه‌دارید';

  @override
  String get stepPreviewHoldButtonSemantic => 'برای پیش‌نمایش نگه‌دارید';

  @override
  String get stepPreviewHoldButtonReleased =>
      'رها شد. جلسه اکنون وارد پنجره مهلت می‌شود.';

  @override
  String get stepPreviewFakeCallHint =>
      'صفحه تماس ساختگی ظاهر می‌شود. برای پاسخ بکشید یا برای شبیه‌سازی هشدار، دکمه قرمز را نگه‌دارید.';
  ...
  @override
  String get stepConfigSmsAutoRecordAudio => 'ضبط خودکار صدا';

  @override
  String get stepConfigSmsAutoRecordVideo => 'ضبط خودکار ویدیو';

  @override
  String get stepConfigSmsRecordDuration => 'مدت ضبط';
  ...
  @override
  String get stepConfigHardwarePressWindow => 'پنجره فشار (میلی‌ثانیه)';

  @override
  String get stepConfigHardwareLongDuration => 'مدت فشار طولانی (ث)';
  ...
  String get audioRunningLatePhrase =>
      'سلام، من دیر می‌رسم. به‌زودی تماس می‌گیرم.';

  @override
  String smsDefaultTemplate(Object name, Object location, Object time) {
    return '$name ممکن است به کمک نیاز داشته باشد. مکان: $location. زمان: $time.';
  }

  @override
  String smsDefaultPreCallTemplate(Object name) {
    return '$name در حال تلاش برای تماس با شماست. لطفاً منتظر تماس باشید.';
  }

  @override
  String simLoudAlarm(Object tail) {
    return '[SIM] هشدار بلند + $tail';
  }

  @override
  String get simLoudAlarmTailFlash => 'فلاش';

  @override
  String get simLoudAlarmTailVibrate => 'لرزش';

  @override
  String simSmsContact(Object channel, int count) {
    return '[SIM] $channel را به $count مخاطب ارسال می‌کند';
  }

  @override
  String simFakeCallRing(Object caller) {
    return '[SIM] تماس ورودی از $caller';
  }

  @override
  String simCountdownWarning(int seconds) {
    return '[SIM] هشدار شمارش معکوس $seconds ثانیه';
  }

  @override
  String simPhoneCall(Object name) {
    return '[SIM] با $name تماس می‌گیرد';
  }

  @override
  String get simNoContactToCall => '[SIM] هیچ مخاطبی برای تماس وجود ندارد';

  @override
  String simCallEmergency(Object number) {
    return '[SIM] $number را شماره‌گیری می‌کند';
  }

  @override
  String get simHardwareButton => '[SIM] محرک سخت‌افزاری مسلح';

  @override
  String get simHoldButton => '[SIM] در انتظار نگه‌داشتن دکمه';

  @override
  String simDisguisedReminder(Object title) {
    return '[SIM] «$title» را نشان می‌دهد';
  }

  @override
  String get simDisguisedReminderEmpty =>
      '[SIM] هیچ الگوی یادآوری در دسترس نیست';

  @override
  String get simGpsArrivalTrigger => '[SIM] محرک رسیدن GPS فعال شد';

  @override
  String get simLowBatteryAlert => '[SIM] هشدار باتری کم فعال شد';
}
