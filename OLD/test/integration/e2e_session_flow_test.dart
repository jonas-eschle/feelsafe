...
List<Override> _overrides({
  ...
  if (noPause)
    sessionControllerProvider.overrideWith(() => _FakeNoPauseController(seed))
  else
...
void main() {
  ...
  group('session screen — hold button step', () {
      ...
      await tester.pumpWidget(
        hostScreenWithRouter(
          overrides: _overrides(
            seed: _session(stepType: ChainStepType.holdButton),
          ),
          child: const SessionScreen(),
        ),
      );
    ...
    testWidgets('session_fakeCall_step_hides_hold_button', (tester) async {
      await tester.pumpWidget(
        hostScreenWithRouter(
          overrides: _overrides(
            seed: _session(stepType: ChainStepType.fakeCall),
          ),
          child: const SessionScreen(),
        ),
      );
  ...
  group('session screen — timer display', () {
    ...
    testWidgets('session_stealth_timerDisplay_false_hides_remaining_seconds', (
      tester,
    ) async {
  ...
  group('session screen — stealth branding', () {
    testWidgets('session_stealth_sessionScreenStealth_hides_title', (
      tester,
    ) async {
  ...
  group('session screen — pause button', () {
    testWidgets('session_pause_button_visible_when_pause_allowed', (
      tester,
    ) async {
      await tester.pumpWidget(
        hostScreenWithRouter(
    ...
    testWidgets('session_pause_button_hidden_when_not_pause_allowed', (
      tester,
    ) async {
      await tester.pumpWidget(
        hostScreenWithRouter(
  ...
  group('session screen — simulation mode', () {
    ...
    testWidgets('session_real_session_hides_simulation_controls', (
      tester,
    ) async {
      await tester.pumpWidget(
        hostScreenWithRouter(
