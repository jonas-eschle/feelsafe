...
void main() {
  ...
  testWidgets('onboarding_fresh_install_shows_onboarding_not_home', (
    tester,
  ) async {
  ...
  testWidgets('onboarding_first_page_has_skip_and_next_buttons', (
    tester,
  ) async {
    await tester.pumpWidget(
      hostScreenWithRouter(
  ...
  testWidgets('onboarding_page_indicators_show_three_dots', (tester) async {
    await tester.pumpWidget(
      hostScreenWithRouter(
        overrides: _overrides(),
        child: const OnboardingScreen(),
  ...
  testWidgets('onboarding_next_advances_to_profile_page_with_text_fields', (
    tester,
  ) async {
    await tester.pumpWidget(
      hostScreenWithRouter(
  ...
  testWidgets('onboarding_next_next_advances_to_permissions_page', (
    tester,
  ) async {
    await tester.pumpWidget(
      hostScreenWithRouter(
  ...
  testWidgets('onboarding_permissions_page_shows_finish_button', (
    tester,
  ) async {
    await tester.pumpWidget(
      hostScreenWithRouter(
  ...
  testWidgets('onboarding_skip_flips_isFirstLaunch_to_false', (tester) async {
  ...
  testWidgets('onboarding_skip_does_not_require_profile_or_contact', (
    tester,
  ) async {
  ...
  testWidgets('onboarding_finish_saves_name_and_contact', (tester) async {
    final settings = FakeSettingsRepository();
    final profile = FakeUserProfileRepository();
    final contacts = FakeContactsRepository();
    await tester.pumpWidget(
  ...
  testWidgets('onboarding_finish_with_empty_name_does_not_save_profile', (
    tester,
  ) async {
    final profile = FakeUserProfileRepository();
    await tester.pumpWidget(
  ...
  testWidgets('onboarding_finish_does_not_save_contact_inline_anymore '
      '(Q26: contacts come from ContactFormScreen)', (tester) async {
    final contacts = FakeContactsRepository();
    await tester.pumpWidget(
      hostScreenWithRouter(
  ...
  testWidgets('onboarding_completion_marks_settings_persisted', (tester) async {
    final settings = FakeSettingsRepository();
    await tester.pumpWidget(
      hostScreenWithRouter(
        overrides: _overrides(settings: settings),
  ...
  testWidgets('onboarding_welcome_page_shows_logo', (tester) async {
    await tester.pumpWidget(
      hostScreenWithRouter(
        overrides: _overrides(),
        child: const OnboardingScreen(),
  ...
  testWidgets('onboarding_profile_page_has_name_field', (tester) async {
    await tester.pumpWidget(
      hostScreenWithRouter(
        overrides: _overrides(),
        child: const OnboardingScreen(),
  ...
  testWidgets('onboarding_finish_settings_has_non_null_defaults', (
    tester,
  ) async {
    final settings = FakeSettingsRepository();
    await tester.pumpWidget(
  ...
  testWidgets('onboarding_isFirstLaunch_true_before_finish', (tester) async {
    final settings = FakeSettingsRepository(
