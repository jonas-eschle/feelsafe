...
void main() {
  testWidgets('picker offers Blank plus one entry per existing mode', (
    tester,
  ) async {
  ...
  testWidgets('picker omits distress modes from the template list', (
    tester,
  ) async {
    final walk = makeMode(id: 'walk', name: 'Walk Mode');
  ...
  testWidgets('picker clones the chosen mode and saves it before routing', (
    tester,
  ) async {
