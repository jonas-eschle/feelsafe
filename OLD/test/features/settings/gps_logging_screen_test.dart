...
void main() {
  ...
  testWidgets('GpsLoggingScreen enable toggle persists value',
      (tester) async {
  ...
  testWidgets('GpsLoggingScreen accuracy dropdown switches to high',
    ...
    await tester.pumpAndSettle();
    check(repo.stored!.defaults.gpsLogging.accuracy)
        .equals(GpsAccuracy.high);
  });

  testWidgets('GpsLoggingScreen includeInSms switch persists',
      (tester) async {
    final repo = FakeSettingsRepository();
    await tester.pumpWidget(hostScreen(
      overrides: [settingsRepositoryProvider.overrideWithValue(repo)],
  ...
  testWidgets('GpsLoggingScreen retention slider updates days',
      (tester) async {
    final repo = FakeSettingsRepository();
    await tester.pumpWidget(hostScreen(
      overrides: [settingsRepositoryProvider.overrideWithValue(repo)],
